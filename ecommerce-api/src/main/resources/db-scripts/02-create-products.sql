...
INSERT INTO product_category(category_name) VALUES ('TECH-BOOKS');

INSERT INTO product_category(category_name) VALUES ('SCIENCE-BOOKS');
...
INSERT INTO product (sku, name, description, image_url, active, units_in_stock,
unit_price, category_id, date_created)
VALUES ('BOOK-SCIENCE-1001', 'The Science Language: ', 'Learn Science and advanced',
'assets/images/products/placeholder.png'
,1,100,24.99,2, NOW());
